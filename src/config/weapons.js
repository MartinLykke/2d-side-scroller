export const WEAPONS = {
  ...
  fire_tome:     { name:"Ildtome",        type:"magic",  dmg:3,  speed:1.3,  range:300, rarity:1, col:"#ff6a2a", spellType:"fireball" },
  hydro_tome:    { name:"Vandtome",       type:"magic",  dmg:2,  speed:0.65, range:270, rarity:1, col:"#4ab8e8", spellType:"waterjet" },
  // --- Tier 2: Sjælden ---
  ...
  lightning_tome:{ name:"Lyntome",        type:"magic",  dmg:5,  speed:1.1,  range:340, rarity:2, col:"#f0e060", spellType:"lightning" },
  meteor_tome:   { name:"Meteortome",     type:"magic",  dmg:8,  speed:2.0,  range:300, rarity:2, col:"#ff8840", spellType:"meteor" },
  // --- Tier 3: Episk (lilla) ---
  ...
  arcane_tome:   { name:"Arkanetome",     type:"magic",  dmg:8,  speed:0.9,  range:400, rarity:3, col:"#b080ff", spellType:"arcane" },
  shadow_tome:   { name:"Skyggetome",     type:"magic",  dmg:11, speed:1.4,  range:380, rarity:3, col:"#8822cc", spellType:"shadow" },
  ...
  void_tome:     { name:"Tomhedstome",    type:"magic",  dmg:15, speed:2.8,  range:460, rarity:4, col:"#e0a0ff", spellType:"void" },
};
