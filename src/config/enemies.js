...
export const ENEMY_TYPES = {
  ...
  // --- Mid game (day 3+) ---
  brute:   { hp: 11, speed: 42,  w: 34, color: "#2a2036", eye: "#ff3c3c", reward: 3,  dmg: 14, meleeDmg: 2, rangedShoot: true, shootRange: 300, shootInterval: 5.5 },
  ...
  boss2:   { name:"Blodridder",     hp: 75,  speed: 28,  w: 78,  color: "#3c0808", eye: "#ff2020", reward: 16, dmg: 26, meleeDmg: 3, noKnockback: true, rangedShoot: true, shootRange: 400, shootInterval: 5 },
  boss3:   { name:"Dødskæmper",     hp: 140, speed: 22,  w: 96,  color: "#060620", eye: "#5020ff", reward: 26, dmg: 32, meleeDmg: 4, noKnockback: true, rangedShoot: true, shootRange: 420, shootInterval: 4.5 },
  boss4:   { name:"Den Udødelige",  hp: 240, speed: 18,  w: 116, color: "#140a14", eye: "#ff20ee", reward: 40, dmg: 40, meleeDmg: 5, noKnockback: true, rangedShoot: true, shootRange: 450, shootInterval: 4 },
